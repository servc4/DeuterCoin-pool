var api = "http://poolhost.com:1817";

var api_blockexplorer = "http://daemonhost.com:18081";
...
var blockchainExplorer = "http://bce.deutercoin.uk/en/?hash={id}#blockchain_block";

var transactionExplorer = "http://bce.deutercoin.uk/en/?hash={id}#blockchain_transaction";

var themeCss = "themes/default-theme.css";

var networkStat = {
"dec": [
        ["pool.deutercoin.uk", "http://pool.deutercoin.uk:8117"],
        ["pool2.deutercoin.uk", "http://pool2.deutercoin.uk:8117"],
        ["graftpool.fr/pooldeuter", "http://graftpool.fr:8116"],
        ["pool.mineallcrypto.com/pool/?symbol=DTC", "http://pool.mineallcrypto.com:5070"]
    ],
    "bcn": [
